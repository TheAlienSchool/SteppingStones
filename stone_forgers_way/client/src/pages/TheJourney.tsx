          ...
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-16">
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg leading-relaxed text-stone-700">
                  This was the first stone: <strong>You are not a student. You are a Tertön.</strong>
                </p>
              </div>
            </section>
            ...
            <section className="mb-16 bg-white border-l-4 border-amber-600 p-8">
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg leading-relaxed text-stone-700">
                  This was the second stone: <strong>The invisible bridge is always here. The question is: what 
                  quality of stepping will you bring to it?</strong>
                </p>
              </div>
            </section>
            ...
            <section className="mb-16">
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg leading-relaxed text-stone-700">
                  This was the third stone: <strong>The synthesis itself is the stepping stone materializing beneath 
                  our feet.</strong>
                </p>
              </div>
            </section>

            {/* Phase 4: The Archetypes */}
            <section className="mb-16 bg-amber-50 p-8 rounded-lg">
              <h2 className="text-3xl font-serif text-stone-800 mb-6">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4 my-8">
                  <div className="bg-stone-50 p-6 rounded-lg">
                    <h3 className="text-xl font-serif text-stone-800 mb-2">The Stone Carrier</h3>
                  ...
                  <div className="bg-stone-50 p-6 rounded-lg">
                    <h3 className="text-xl font-serif text-stone-800 mb-2">The Stone Thrower</h3>
                    <p className="text-stone-700">
                  ...
                  <div className="bg-stone-50 p-6 rounded-lg">
                    <h3 className="text-xl font-serif text-stone-800 mb-2">The Conscious Forger</h3>
                    <p className="text-stone-700">
                  ...
                  <div className="bg-stone-50 p-6 rounded-lg">
                    <h3 className="text-xl font-serif text-stone-800 mb-2">The Stone Forger</h3>
                    <p className="text-stone-700">
                ...
                <p className="text-lg leading-relaxed text-stone-700">
                  This was the fourth stone: <strong>You are all of these at once. Choose, in this moment, 
                  to let the Forger lead.</strong>
                </p>
              </div>
            </section>
            ...
            <section className="mb-16">
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg leading-relaxed text-stone-700">
                  This was the fifth stone: <strong>We don't need to rebrand Patience. We need to un-brand 
                  ourselves from the culture that stole its meaning.</strong>
                </p>
              </div>
            </section>
            ...
            <section className="mb-16 bg-white border-l-4 border-amber-600 p-8">
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg leading-relaxed text-stone-700">
                  This was the sixth stone: <strong>The backache is the teacher. Stop throwing. Start forging.</strong>
                </p>
              </div>
            </section>
            ...
            <section className="mb-16">
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg leading-relaxed text-stone-700">
                  This was the seventh stone: <strong>There is no shame in this partnership. This is evolution. 
                  Release the wealth.</strong>
                </p>
              </div>
            </section>
            ...
            <section className="mb-16 bg-amber-50 p-8 rounded-lg">
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg leading-relaxed text-stone-700">
                  This was the eighth stone: <strong>The lineage continues. The candle burns. The stones are forged.</strong>
                </p>
              </div>
            </section>
            ...
            <section className="mb-16 bg-white border-l-4 border-amber-600 p-8">
              ...
              <div className="space-y-8">
                ...
                <p className="text-xl leading-relaxed text-stone-700 text-center font-serif italic">
            ...
            <div className="flex justify-center gap-4 mt-16">
              ...
              <Link href="/practices">
                <button className="bg-stone-600 hover:bg-stone-700 text-white px-8 py-3 rounded-lg transition-colors">
                  Begin the Practices
                </button>
              </Link>
            </div>
