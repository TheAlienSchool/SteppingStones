            ...
            <article className="space-y-8">
              <div className="bg-amber-50 p-8 rounded-lg mb-8 space-y-8">
                <p className="text-lg leading-relaxed text-stone-700 mb-0">
                  ...
                  in the <GlossaryTooltip term="Tertön">tertön</GlossaryTooltip>.
                </p>
              </div>
              ...
              <div className="bg-stone-50 p-6 rounded-lg space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-stone-700">Phygital Discovery Lab at Momentum Worldwide—the sensibility forming</p>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-amber-600 font-mono text-sm whitespace-nowrap">2016</span>
                  <p className="text-stone-700">First encounter with Aaron's Gamelatron in Brooklyn—the postcard flyer kept</p>
                </div>
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-stone-700">Launch of THE ÅLïEN SCõÖL for Creative Thinking—born from the Shim Sham</p>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-amber-600 font-mono text-sm whitespace-nowrap">Feb 2025</span>
                  <p className="text-stone-700">Move to Gastonia, NC with Omar and Sameerah—the creative family home</p>
                </div>
                <div className="flex items-start gap-4">
