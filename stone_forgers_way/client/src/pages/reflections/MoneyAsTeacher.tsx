        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <article className="space-y-8">
              ...
              <p className="text-lg leading-relaxed text-stone-700">
                We have been taught to see money and generosity as opposites. Either you give it away for free (and prove you're spiritual), or you charge for it (and prove you're greedy). This is the tyranny of the binary. This is the Stone Thrower's logic: if it costs money, it must be corrupt.
              </p>
...
<p className="text-lg leading-relaxed text-stone-700">
  It becomes dead weight. The only 
              ...
              <p className="text-lg leading-relaxed text-stone-700">
                The contribution structure on this site is not arbitrary. It is designed to honor different levels of resonance:
              </p>

              <p className="text-lg leading-relaxed text-stone-700">
                <strong>$11 — The Acknowledgment.</strong> This says, "I see what you're doing. Thank you for releasing this into the Field." It is the energetic equivalent of a nod. A recognition. A simple exchange of resonance.
              </p>
              ...
              <p className="text-lg leading-relaxed text-stone-700">
                <strong>$108 — The Sacred Number.</strong> In many spiritual traditions, 108 is a number of completion. 108 beads on a mala. 108 sun salutations. 108 as the distance between the Earth and the Sun in solar diameters. This contribution says, "This work has changed something fundamental in me. I want to honor that."
              </p>
