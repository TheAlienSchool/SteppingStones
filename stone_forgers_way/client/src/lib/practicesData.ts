...
export const practices: Practice[] = [
  // CORE ARCHETYPE PRACTICES (from existing system)
  {
    ...
    instructions: 'Place your hands on your lower back. Breathe into the weight. Ask: "What load do I carry that belongs to ancestral lineages?" Listen for the answer in your body; align with physical sensation rather than conceptual thinking.',
  ...
  },
  {
    ...
    instructions: 'Exhale fully, imagining each suspended stone dissolving into light. This is an act of restoration—you return what belongs to other times and lineages. Repeat for 10 breaths.',
    coreArchetypeTags: ['carrier'],
    expandedArchetypeTags: ['stone-keeper'],
  ...
  },
  {
    ...
    instructions: 'Before responding in anger, take three breaths. Ask: "Is this stone mine to throw, or am I defending against an imagined friction?" Let the answer emerge, allowing ease rather than effort.',
  ...
  },
  {
    ...
    instructions: 'When you recognize you\'ve thrown a stone, apologize quickly and with transparency. This transforms the pattern. Say: "I threw that stone. I see it. I\'m sorry." Offer only direct truth, omitting defensiveness.',
    coreArchetypeTags: ['thrower'],
    expandedArchetypeTags: ['stone-breaker'],
  ...
  },
  {
    ...
    instructions: 'Each morning, commit to a single stone. Focus your energy on this choice alone. Bring your full presence to it. Release attachment to all other options for this day.',
  ...
  },
  {
    ...
    instructions: 'Allow your work to extend beyond yourself. Let it overflow. Choose one insight, one creation, or one gift from this week. Offer it freely. Experience this value exchange as pure overflow.',
    coreArchetypeTags: ['forger'],
  ...
  // EXPANSION KIT v1.2 PRACTICES (The Six Core Practices)
  {
    ...
    instructions: 'Before picking up any stone (obligation, belief, project), pause and examine its underlying structure. Ask: "What belief system created this stone? Does this code align with my primary system, or is it an external program?" Write down the belief beneath the burden.',
  ...
  },
  {
    ...
    instructions: 'Before making a decision, place your hand on your heart. Ask: "Does this align with the Way I sense?" Wait for the resonance—direct somatic knowing. The compass lives in your body; trust the pull toward the Peak, even when the path ahead reveals itself only step-by-step.',
    coreArchetypeTags: ['conscious', 'forger'],
  ...
  },
  {
    ...
    instructions: 'When you feel burdened by a "sacred obligation," pause and ask: "Is this stone mine, or does it belong to the ancestors? Is this stone for me to carry, or for me to honor and return?" Speak aloud: "I honor what you carried. I return this weight to its source, holding only my true path."',
    coreArchetypeTags: ['carrier'],
    expandedArchetypeTags: ['stone-keeper'],
    duration: '5-10 minutes',
  ...
  },
  {
    ...
    instructions: 'When frustration builds, ground the energy immediately. Channel it into one focused action. Write the pattern you wish to transform on paper. Tear the paper with intention. Breathe. Ask: "What small, precise change can I make right now to redirect this energy?"',
  ...
  },
  {
    ...
    instructions: 'Before making any commitment, promise, or declaration of intent, pause for three breaths. Feel into your body. Ask: "Is this aligned? Do I have the energy to forge this stone?" Speak only when you feel resonance. Welcome the practice of: "Let me reflect on that and return to you."',
    coreArchetypeTags: ['conscious'],
  ...
  },
  {
    ...
    instructions: 'Choose one challenging situation in your life (a conflict, a problem, an emotion). Set a timer for 5 minutes. Simply observe it, allowing it to be exactly as it is. Notice the urge to act. Breathe through it. Practice being the immovable center while the storm passes around you.',
    coreArchetypeTags: ['conscious', 'forger'],
    expandedArchetypeTags: ['stone-witness'],
    duration: '5-10 minutes',
    frequency: 'Daily',
  ...
  },
  {
    ...
    instructions: 'Document your path. Do this for the benefit of those who will walk after you. Each week, write one insight from your journey. One stone you forged. One decision made by inner compass. This becomes the map, guiding the lineage you are creating.',
    coreArchetypeTags: ['conscious', 'forger'],
    expandedArchetypeTags: ['walker-of-the-way'],
    duration: '10-15 minutes',
    frequency: 'Weekly',
  ...
  },
  {
    ...
    instructions: 'Active listening practice: When someone shares their struggle, simply hold space. Reflect back what you hear, keeping your own story separate. "It sounds like you\'re feeling..." This is presence in action.',
    coreArchetypeTags: ['conscious', 'forger'],
    expandedArchetypeTags: ['stone-witness'],
    duration: 'As long as needed',
  ...
  // ADDITIONAL SUPPORTIVE PRACTICES
  {
    ...
    instructions: 'Allow the seed to mature in active patience. Settle the urge to force, and remain present to its growth. Tend it. Water it. Give it light. Trust the rate of materialization while actively supporting the process.',
    coreArchetypeTags: ['conscious', 'forger'],
  ...
  },
  {
    ...
    instructions: 'Stand flat-footed on the Dojo floor, eyes closed. Somaticize the structural load currently felt in your chest or shoulders. Visualize this load traveling straight down your spine, passing through your feet, and anchoring into a solid, glowing stepping stone laid precisely in 1937. Speak aloud: "I stand on firm coordinates. The vector laid in 1937 holds the weight of my step in 2026." Feel the vagal tone release as the ancestral coordinate absorbs the somatic friction.',
    coreArchetypeTags: ['forger'],
